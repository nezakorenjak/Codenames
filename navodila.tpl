% rebase('base.tpl', title = 'Navodila')

<h2>Pravila za igranje:</h2>

<p>Pred vami je 16 polj z različnimi besedami – del besed pripada eni ekipi,
...
ne izbere besede morilca.</p>

<a class="btn btn-secondary" href="/" role="button">Nazaj</a>
